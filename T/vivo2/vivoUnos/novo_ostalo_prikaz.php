...
// ostalo, unutar projekta  /
$upit = "SELECT id, povrsina, povrsina, aktivno, cijena FROM ".$tabela." WHERE idProjekta = '".$idProjekta."' ORDER BY id DESC";
$odgovori = mysql_query ( $upit );
$i = 0;
while ( $podaci = mysql_fetch_assoc ( $odgovori ))  {
    ...
    <div class="lineRight">',$podaci['povrsina'],' m<sup>2</sup> : ',$podaci['cijena'],' &euro; - ';
