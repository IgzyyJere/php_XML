...
************************************************************************************************************/	
	...
	var form_widget_amount_slider_handle = '/vivo2/elementi/slider_handle.gif';
	...
	function chooseColor()
	{
		...
		color_picker_div.style.display='none';
		editorExec.execCommand('ForeColor', false, this.getAttribute('rgbColor'));
	}
	...
	function chooseColorSlider()
	{
		...
		color_picker_div.style.display='none';	
		editorExec.execCommand('ForeColor', false, document.getElementById('js_color_picker_color_code').value);
	}
	
	/* Custom made function for adding editor font color support */
	var editorExec = false;
	function showColorPickerCustom(inputObj,formField,editor)
	{
		if(!color_picker_div){
