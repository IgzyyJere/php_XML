...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            increaseFontSizeIE : { visible : true && ( $.browser.msie ), tags : ['big'] },
            decreaseFontSizeIE : { visible : true && ( $.browser.msie ), tags : ['small'] },
			...
			fontColor : { visible : true && !( $.browser.msie ), tags : ['big'] }
        }
    });
        ...
        appendMenu : function( cmd, args, className, fn )
        {
            ...
            $('<li></li>').append(
                ...
                if ( fn ) { 
                	...
                	if(cmd == 'increaseFontSizeIE') {
                		if(fontSize < 7) {
                			fontSize += 1;
                		}                		
                		var font = fontSize.toString();
                		self.editorDoc.execCommand('FontSize', false, font);
                	} else if(cmd == 'decreaseFontSizeIE') {
                		if(fontSize > 1) {
                			fontSize -= 1;
                		}
                		var font = fontSize.toString();
                		...
                		showColorPickerCustom(this,null,self.editorDoc);
						//self.editorDoc.execCommand('ForeColor', false, 'red');
                	} else {
