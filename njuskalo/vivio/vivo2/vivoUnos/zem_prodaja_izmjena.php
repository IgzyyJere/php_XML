...
formUpdate ( "Površina", "povrsina", $podaci['povrsina'] );
formUpdate ( "Širina", "sirina", $podaci['sirina'] ) ;
formUpdate ( "Dužina", "duzina", $podaci['duzina'] ) ;
formUpdate ( "Cijena", "cijena", $podaci['cijena'] ); 
radioUpdate ( "Dodati PDV na cijenu", "pdv", $podaci['pdv'] ); 
mixedUpdate ( "Širina pristupnog puta", "sirinaPristupa", $podaci['sirinaPristupaOption'], $podaci['sirinaPristupaValue'] );
