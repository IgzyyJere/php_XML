...
if (!isset($_SERVER['PHP_AUTH_USER'])) {
      ...
      $dataToLog = array(
        ...
        $headers = "From: sytem@mojecipele.com";
      ...
      if($_SERVER['PHP_AUTH_USER'] == "moje!cipele_22@B" && $_SERVER['PHP_AUTH_PW'] == "MpY4vyFNek34MSNtNFqN"){
        ...
        $url = "https://www.webzy.com.hr/cipele/app-SvP/data.json";
        ...
        $data = json_decode($json,true);
          ...
          for ($x = 0; $x < $countProductJson; $x++) {
            ...
            if($productID["post_id"] !== null){
              ...
              if($VId["ID"] !== null){
                ...
                if($st == $st1){
                                ...
                                if($komada > $onStock){
                                  ...
                                  $message = "Nema dovoljno na lageru prozvod SKU : ".$SKU.", bazzarID : ". $bazzarId.", komada se prodaje :".$komada." ,broj cipele :".$variantData;
                                  $dataLog = "SKU :".$SKU; 
                                  $dataToLog = array(
                                    date("d-m-Y H:i:s"), //Date and time
                                    $_SERVER['REMOTE_ADDR'], //IP address
                                  ...
                                  $to = "igorsfera7@gmail.com";
                                  $subject = "Prodaja bazzar - NEMA DOVOLJNO NA LAGERU";
                                  $txt = "Upravo je prodan artikl na bazzar shopu,"."\r\n".
                                  "broj proizvoda :".$countProductJson."\r\n".
                                  "Proizvod (Bazzar id , SKU): ".$bazzarId. " ," .$SKU."\r\n".
                                  "Naziv proizvoda : ".$title ."\r\n".
                                ...
                                if($komadOstalo == 0){
                                  ...
                                  $message = "Problem s stanjem SKU : ".$SKU.", bazzarID : ". $bazzarId.", komada se prodaje :".$komada." ,broj cipele :".$variantData;
                                  $dataLog = "SKU :".$SKU;
                                  $dataToLog = array(
                                    date("d-m-Y H:i:s"), //Date and time
                                    $_SERVER['REMOTE_ADDR'], //IP address
                               ...
                               // echo " Search bit baz#%".$bazzarId;
                                ...
                                //echo '<br/> bazar search : '. $getPostIdQuery;
                                          ...
                                          if ($link->query($InsertQuery) === TRUE) 
                                          {
                                                ...
                                                $message = "USPJEŠAN UNOS SKU : ".$SKU.", bazzarID : ". $bazzarId.", komada se prodaje :".$komada." ,broj cipele :".$variantData;
                                                $dataLog = "SKU :".$SKU;
                                                $dataToLog = array(
                                                  date("d-m-Y H:i:s"), //Date and time
                                                  $_SERVER['REMOTE_ADDR'], //IP address
                                                  ...
                                                  $dataLog//data
                                                      ...
                                                      $link->query($InsertMetaData18); 
                                                                ...
                                                                $link->query($InsertWooMetaData9);  //smanjeuje se komada
                                                                      ...
                                                                      curl_close($ch);
                                                                      $message = "STATUS KOD ERROR SKU : ".$SKU.", bazzarID : ". $bazzarId.", komada se prodaje :".$komada." ,broj cipele :".$variantData;
                                                                      $dataLog = "ERORROR KOD :".$status_code;
                                                                      $dataToLog = array(
                                                                        date("d-m-Y H:i:s"), //Date and time
                                                                        $_SERVER['REMOTE_ADDR'], //IP address
                                                                        'Error', //Custom text
                       ...
                       // echo $st. " -nema dovoljno na lageru ";
                        $message = "NEMA DOVOLJNO NA LAGERU SKU : ".$SKU.", bazzarID : ". $bazzarId.", komada se prodaje :".$komada." ,broj cipele :".$variantData;
              ...
              echo "nema proizvoda";
              $message = "NEMA PROIZVODA SKU : ".$SKU.", bazzarID : ". $bazzarId.", komada se prodaje :".$komada." ,broj cipele :".$variantData;
