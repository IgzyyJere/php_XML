...
function createXMLfile($nekrsArray){
   ...
   $filePath = 'prerade/nekretnine_stanovi.xml';
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="">Stanovi <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<div class="jumbotron">
  <h1 class="display-4">Stanovi</h1>
  <p class="lead">Uspjeh , rješeni stanovi</p>
  <hr class="my-4">
